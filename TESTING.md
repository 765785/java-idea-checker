...
| Pages / Release | Pages 入口和静态资源 HTTP 200；Release 固定资产的 SHA-256 与 README 表一致 | 2026-09-25：c7b6673 工作流 build/deploy 成功；首页 HTTP 200 且含 ZIP 新流程；v1.0.0 的两个固定资产 SHA-256 已由 Release API 核对 |
